...
const Login = () => {
  ...
  const handleLogin = () => {
    const params = new URLSearchParams({
      ...
      prompt: "consent", // Always ask to re-consent (good for testing)
    });
      ...
      <div className={styles.loginContainer}>
        ...
        <div className={styles.loginForm}>
          ...
          <div className={styles.orDivider}>
            ...
            <span className={styles.orText}>Secure & Fast</span>
            <div className={styles.orLine}></div>
          </div>
          ...
          <div className={styles.featuresGrid}>
            <div className={styles.feature}>
              ...
              <p className={styles.featureText}>Secure</p>
            </div>
            <div className={styles.feature}>
              <svg className={styles.featureIcon} viewBox="0 0 24 24" fill="currentColor">
              ...
              <p className={styles.featureText}>Fast</p>
            </div>
            <div className={styles.feature}>
              <svg className={styles.featureIcon} viewBox="0 0 24 24" fill="currentColor">
                <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
              </svg>
              <p className={styles.featureText}>Trusted</p>
            </div>
          </div>
        </div>
