    ...
    <div className={styles.container}>
      <div className={styles.content}>
        <header className={styles.header}>
          ...
          <p className={styles.lastUpdated}>Last updated: September 28, 2025</p>
        </header>
        ...
        <section className={styles.section}>
          ...
          <dl className={styles.definitions}>
            ...
            <dd>(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Interview.</dd>
            ...
            <dd>refers to: Maharashtra, India</dd>
            ...
            <dd>refers to Interview, accessible from <a href="https://www.roshanpatil.com" className={styles.link}>https://www.roshanpatil.com</a></dd>
        ...
        <section className={styles.section}>
          ...
          <div className={styles.cookieTypes}>
            <div className={styles.cookieType}>
              <h4 className={styles.subheading}>Cookies or Browser Cookies</h4>
              <p>A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service.</p>
            </div>
            
            <div className={styles.cookieType}>
              <h4 className={styles.subheading}>Web Beacons</h4>
              <p>Certain sections of our Service and our emails may contain small electronic files known as web beacons that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics.</p>
            </div>
          </div>

          <h3 className={styles.subsectionTitle}>Cookie Categories</h3>
          <div className={styles.cookieCategories}>
            <div className={styles.cookieCategory}>
              <h4 className={styles.subheading}>Necessary / Essential Cookies</h4>
              <ul className={styles.cookieDetails}>
                <li><strong>Type:</strong> Session Cookies</li>
                <li><strong>Administered by:</strong> Us</li>
                <li><strong>Purpose:</strong> These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features.</li>
              </ul>
            </div>
            
            <div className={styles.cookieCategory}>
              <h4 className={styles.subheading}>Cookies Policy / Notice Acceptance Cookies</h4>
              <ul className={styles.cookieDetails}>
            ...
            <div className={styles.cookieCategory}>
              <h4 className={styles.subheading}>Functionality Cookies</h4>
              <ul className={styles.cookieDetails}>
                <li><strong>Type:</strong> Persistent Cookies</li>
                <li><strong>Administered by:</strong> Us</li>
                <li><strong>Purpose:</strong> These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference.</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>By email: <a href="mailto:contact.roshanpatil@gmail.com" className={styles.link}>contact.roshanpatil@gmail.com</a></p>
        </section>

        <footer className={styles.footer}>
          <p className={styles.footerText}>© 2025 Roshan Patil. All rights reserved.</p>
        </footer>
      </div>
    </div>
  );
